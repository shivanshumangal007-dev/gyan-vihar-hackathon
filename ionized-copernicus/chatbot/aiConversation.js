 ...
 * 
 * Handles AI-powered conversations using OpenAI GPT-4o-mini
 * Maintains safety constraints and empathetic responses
 */

const OpenAI = require('openai');
const { validateResponse, validateActions } = require('./safetyValidator');

const openai = new OpenAI({
    apiKey: process.env.OPENAI_API_KEY
});

const SYSTEM_PROMPT = `You are a mental first-aid assistant for students on the NORMAL wellness platform. You are calm, brief, empathetic, and limited.
 ...
 * @returns {Promise<Object>} - { message, actions, emotion, intensity }
 */
